#' MRcML Method (High-Dimensional Version)
#'
#' This is the main function of the high-dimensional MRcML method, without
#' data perturbation. It differs from the standard \code{mr_cML} in the
#' standard error estimation, which uses a RAPS-style sandwich variance for
#' better calibration in high-dimensional settings.
#'
...
#'
#' @examples
mr_cML_hd <- function(b_exp,b_out,
                   se_exp,se_out,
