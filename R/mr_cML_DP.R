#' MRcML Method with Data Perturbation (High-Dimensional Version)
#'
#' This is the main function of the high-dimensional MRcML method with data
#' perturbation. It differs from the standard \code{mr_cML_DP} in the standard
#' error estimation, which uses a RAPS-style sandwich variance for better
#' calibration in high-dimensional settings.
#'
...
#'
#' @examples
mr_cML_DP_hd <- function(b_exp,b_out,
                      se_exp,se_out,
